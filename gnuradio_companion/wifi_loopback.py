...
class wifi_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._snr_range = qtgui.Range(-15, 30, 0.1, 30, 200)
        ...
        self._noise_range = qtgui.Range(0, 1, 0.1, 0, 200)
        ...
        self.zeromq_pull_msg_source_0_0_0_0 = zeromq.pull_msg_source('tcp://127.0.0.1:50003', 100, False)
        self.zeromq_pull_msg_source_0_0_0 = zeromq.pull_msg_source('tcp://127.0.0.1:50002', 100, False)
        self.zeromq_pull_msg_source_0_0 = zeromq.pull_msg_source('tcp://127.0.0.1:50001', 100, False)
        self.zeromq_pull_msg_source_0 = zeromq.pull_msg_source('tcp://127.0.0.1:50000', 100, False)
        self.zeromq_pub_msg_sink_0_0 = zeromq.pub_msg_sink('tcp://127.0.0.1:60004', 100, True)
        self.zeromq_pub_msg_sink_0 = zeromq.pub_msg_sink('tcp://127.0.0.1:60002', 100, True)
        ...
        self._pdu_length_range = qtgui.Range(0, 1500, 1, 64, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._interval_range = qtgui.Range(10, 1000, 1, 1000, 200)
        ...
        self.foo_packet_pad2_0 = foo.packet_pad2(False, True, 0.001, 500, 0)
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=True)
        self.blocks_var_to_msg_0_0_0_0 = blocks.var_to_msg_pair('encoding_changed')
        self.blocks_var_to_msg_0_0_0 = blocks.var_to_msg_pair('epsilon_changed')
        self.blocks_var_to_msg_0_0 = blocks.var_to_msg_pair('noise_changed')
        self.blocks_var_to_msg_0 = blocks.var_to_msg_pair('snr_changed')
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_cc((10**(snr/10.0))**.5, 1)
        self.blocks_msgpair_to_var_0_0_0_0_0 = blocks.msg_pair_to_var(self.set_noise)
        self.blocks_msgpair_to_var_0_0_0_0 = blocks.msg_pair_to_var(self.set_encoding)
        self.blocks_msgpair_to_var_0_0_0 = blocks.msg_pair_to_var(self.set_epsilon)
        self.blocks_msgpair_to_var_0_0 = blocks.msg_pair_to_var(self.set_snr)
        ...
        self.msg_connect((self.ieee802_11_mac_0, 'phy out'), (self.zeromq_pub_msg_sink_0, 'in'))
        ...
        self.msg_connect((self.wifi_phy_hier_0, 'mac_out'), (self.zeromq_pub_msg_sink_0_0, 'in'))
        self.msg_connect((self.zeromq_pull_msg_source_0, 'out'), (self.blocks_msgpair_to_var_0_0, 'inpair'))
        self.msg_connect((self.zeromq_pull_msg_source_0_0, 'out'), (self.blocks_msgpair_to_var_0_0_0, 'inpair'))
        self.msg_connect((self.zeromq_pull_msg_source_0_0_0, 'out'), (self.blocks_msgpair_to_var_0_0_0_0, 'inpair'))
        self.msg_connect((self.zeromq_pull_msg_source_0_0_0_0, 'out'), (self.blocks_msgpair_to_var_0_0_0_0_0, 'inpair'))
    ...
    def set_snr(self, snr):
        ...
        self.blocks_var_to_msg_0.variable_changed(self.snr)
    ...
    def set_noise(self, noise):
        self.noise = noise
        self.blocks_var_to_msg_0_0.variable_changed(self.noise)
    ...
    def set_epsilon(self, epsilon):
        ...
        self.blocks_var_to_msg_0_0_0.variable_changed(self.epsilon)
    ...
    def set_encoding(self, encoding):
        ...
        self._encoding_callback(self.encoding)
        self.blocks_var_to_msg_0_0_0_0.variable_changed(self.encoding)
