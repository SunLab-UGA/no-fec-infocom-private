...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_sigmf_source_minimal_0 = blocks.file_source(gr.sizeof_gr_complex, '/home/buddy/Documents/sigMF_captures/802_11_5.89G/sigMF_capture1.sigmf-data', True, 0, 0)
        ...
        self.connect((self.blocks_sigmf_source_minimal_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.blocks_sigmf_source_minimal_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_sigmf_source_minimal_0, 0), (self.blocks_multiply_xx_0, 0))
